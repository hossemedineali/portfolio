...
export const Code = () => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto pt-2 flex w-full   flex-wrap opacity-70 font-bold items-center justify-center">
        <motion.div
          className="w-[350px]  "
