  ...
  return (
    ...
    >
     ...
     animate={{right:0}}
        ...
        id="line1B"
        className="absolute bottom-0 h-5 w-full bg-black  "
      ></motion.div>
       ...
       transition={{duration:0.3,delay:0.25,ease:'linear'}}
        id="line2R"
        className="absolute right-0 top-0 bottom-0  w-5 bg-black "
      ></motion.div>
       ...
       transition={{duration:0.3,delay:0.55,ease:'linear'}}
        id="line3T"
        className="absolute right-0 top-0 left-0  h-5 bg-black  "
      ></motion.div> 
...
<motion.div
       ...
       transition={{duration:0.3,delay:0.85,ease:'linear'}}
        id="line4L"
        className="absolute left-0 top-0 bottom-0  w-5 bg-black  "
      ></motion.div> 
...
className="w-full h-screen absolute top-0   bottom-0 bg-black "
>
